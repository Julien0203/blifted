...
(function () {
  ...
  const T = {
    fr: {
      ...
      /* ── HOME — HERO ─────────────────────────────────── */
      'home.hero.eyebrow':       'Transport Privé · Haut de Gamme',
      'home.hero.cta1':          'Confier un déplacement',
      'home.hero.cta2':          'Notre approche',
      'home.hero.trust':         "Partenaire officiel Aéroport d'Avignon-Provence",
      ...
      /* ── HOME — WEDDING ──────────────────────────────── */
      'home.wedding.eyebrow':    'Mariages',
      'home.wedding.badge':      'Coordination complète',
      'home.wedding.feat1.t':    'Coordinateur dédié',
      'home.wedding.feat1.d':    'Un seul interlocuteur pour toute la logistique transport du mariage',
      'home.wedding.feat2.t':    'Timing parfait',
      'home.wedding.feat2.d':    'Planification minutieuse et synchronisation en temps réel le jour J',
      'home.wedding.feat3.t':    'Service blanc gants',
      'home.wedding.feat3.d':    "Attention aux détails, présentation impeccable, atmosphère de prestige",
      'home.wedding.cta':        "Découvrir l'offre mariage",

      /* ── HOME — TESTIMONIALS ─────────────────────────── */
      'home.testimonials.eyebrow': 'Témoignages',
      'home.test1.quote':   '"Un service d\'une précision absolue. Le chauffeur était là 20 minutes avant l\'heure convenue, le véhicule impeccable. Aucun stress, aucune approximation."',
      'home.test1.name':    'Caroline M.',
      'home.test1.role':    'Directrice artistique, Paris',
      ...
      'home.proc2.title':  'Un devis sous 2h',
      ...
      /* ── WEDDINGS PAGE ───────────────────────────────── */
      'weddings.hero.eyebrow': 'Transport mariage',
      'weddings.hero.cta1':    'Synchroniser notre mariage',
      'weddings.hero.cta2':    'Voir le processus',
      'weddings.coord.eyebrow':'Nos coordinations',
      'weddings.coord1.title': 'Transferts aéroport / gare',
      'weddings.coord2.title': 'Arrivées échelonnées des mariés',
      'weddings.coord3.title': 'Rotations villa → cérémonie → réception',
      'weddings.coord4.title': 'Transferts de fin de soirée',
      'weddings.proc.eyebrow': 'Notre processus',
      'weddings.proc1.title':  'Réunion de briefing',
      'weddings.proc2.title':  'Planning de transport',
      'weddings.proc3.title':  'Coordination le Jour J',
      'weddings.planners.eyebrow': 'Pour les wedding planners',
      'weddings.planners.cta': 'Proposer un partenariat',
      'weddings.territories.eyebrow': "Zones d'intervention",
      'weddings.cta.btn1':     'Synchroniser notre mariage',
      'weddings.cta.btn2':     'Partenariat wedding planner',
    ...
    en: {
      ...
      /* ── HOME — HERO ─────────────────────────────────── */
      'home.hero.eyebrow':       'Premium Private Chauffeur',
      'home.hero.cta1':          'Plan a journey',
      'home.hero.cta2':          'Our approach',
      'home.hero.trust':         'Official partner — Avignon-Provence Airport',
      ...
      'home.wedding.badge':      'Full coordination',
      'home.wedding.feat1.t':    'Dedicated coordinator',
      'home.wedding.feat1.d':    'One single contact for all wedding transport logistics',
      'home.wedding.feat2.t':    'Perfect timing',
      'home.wedding.feat2.d':    'Meticulous planning and real-time synchronisation on the wedding day',
      'home.wedding.feat3.t':    'White-glove service',
      'home.wedding.feat3.d':    'Attention to detail, impeccable presentation, prestigious atmosphere',
      'home.wedding.cta':        'Discover our wedding service',

      /* ── HOME — TESTIMONIALS ─────────────────────────── */
      'home.testimonials.eyebrow': 'Testimonials',
      'home.test1.quote':   '"An absolutely precise service. The chauffeur was there 20 minutes early, vehicle immaculate. No stress, no approximation."',
      'home.test1.name':    'Caroline M.',
      'home.test1.role':    'Art Director, Paris',
      ...
      'home.proc2.title':  'Quote within 2h',
      ...
      'services.s3.cta':       'Learn more about weddings',
      ...
      /* ── WEDDINGS PAGE ───────────────────────────────── */
      'weddings.hero.eyebrow': 'Wedding transport',
      'weddings.hero.cta1':    'Coordinate our wedding',
      'weddings.hero.cta2':    'See the process',
      'weddings.coord.eyebrow':'Our coordination',
      'weddings.coord1.title': 'Airport / station transfers',
      'weddings.coord2.title': 'Staggered arrivals of the couple',
      'weddings.coord3.title': 'Villa → ceremony → reception',
      'weddings.coord4.title': 'End-of-evening transfers',
      'weddings.proc.eyebrow': 'Our process',
      'weddings.proc1.title':  'Briefing meeting',
      'weddings.proc2.title':  'Transport plan',
      'weddings.proc3.title':  'Coordination on the day',
      'weddings.planners.eyebrow': 'For wedding planners',
      'weddings.planners.cta': 'Propose a partnership',
      'weddings.territories.eyebrow': 'Coverage areas',
      'weddings.cta.btn1':     'Coordinate our wedding',
      'weddings.cta.btn2':     'Wedding planner partnership',
