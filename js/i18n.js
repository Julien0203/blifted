...
(function () {
  ...
  const T = {
    ...
    en: {
      ...
      'services.hero.sub':     'Designed for luxury professionals and their clients. One single standard: irreproachable, at every step.',
      ...
      'services.std2.text':    'You will never have to repeat your context. One person knows your file from A to Z and remains available throughout the mission.',
      ...
      'services.std4.text':    'Impeccable interior, full tank, climate control set, mineral water available. Nothing is left to chance.',
      ...
      'services.cta.title':    'Describe your programme.',
      ...
      'fleet.hero.title':      'The vehicle is not the argument. <em style="font-style:italic;">It is the frame.</em>',
      'fleet.hero.sub':        'Each vehicle is selected according to the context of the mission. No unnecessary flamboyance — the right car for the right situation.',
      ...
      'fleet.v.spec.lug':      'Large volume',
      'fleet.v.cta':           'Reserve the V-Class →',
      'fleet.gle.tagline':     'The reference for mountain roads and high-stature missions',
      'fleet.gle.spec.terrain':'All-terrain',
      'fleet.gle.cta':         'Reserve the GLE →',
      'fleet.e.tagline':       'Elegance and discretion — when understated is exactly the right signal',
      'fleet.e.spec.ambiance': 'Discreet',
      'fleet.e.cta':           'Reserve the E-Class →',
      'fleet.s.tagline':       'The pinnacle. When the symbol must match the substance.',
      'fleet.s.spec.ambiance': 'Ultra-prestige',
      'fleet.s.cta':           'Reserve the S-Class →',
      ...
      'fleet.tag.villas':      'Villas',
      'fleet.tag.prestige':    'Prestige',
      'fleet.tag.executive':   'Executive missions',
      'fleet.tag.ceremonies':  'Ceremonies',
      'fleet.tag.ultra_prestige': 'Ultra-prestige',
      'fleet.philosophy.title': 'The choice of vehicle<br><em>is not trivial.</em>',
      'fleet.philosophy.body1': "A GLE in the Alps is not an image choice — it is a safety and terrain expertise decision. An S-Class for a confidential meeting is not vanity — it is the signal that you give your interlocutor your total attention.",
      ...
      'weddings.stat1':        'Formalised B2B partnerships',
      ...
      'weddings.proc3.text':   'Direct line with your coordinator, issues handled in complete silence. You will never know there was a constraint — because we absorbed it before it reached you.',
      ...
      'weddings.meg.desc':     "Megève in winter is an exceptional wedding destination: luxury private chalets, snowy surroundings, absolute intimacy. A season still underexploited — and that is exactly where B.LIFTED makes the difference.",
      ...
      'weddings.meg.li5':      'Exclusive partnership possible for WPs positioned in Megève',
      ...
      'contact.hero.title':    'Describe<br><em>the context.</em>',
      'contact.lead':          'A sensitive journey never begins with a reservation. It begins with a <em>precise understanding of what is at stake.</em>',
      'contact.channel.phone': 'Phone',
      'contact.channel.email': 'Email',
      'contact.channel.whatsapp.value': 'Fast response',
